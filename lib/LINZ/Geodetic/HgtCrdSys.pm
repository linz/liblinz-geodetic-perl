...
#===============================================================================
#
#   Class:       LINZ::Geodetic::HgtCrdSys
#
#   Description: Defines the following routines:
#                Constructor
#                  $hcs = new LINZ::Geodetic::HgtCrdSys($name, $hgtref, $offset)
#
...
package LINZ::Geodetic::HgtCrdSys;
...
#   Method:       new
#
#   Description:  $hcs = new LINZ::Geodetic::HgtCrdSys($name, $hgtref, $offset, $code)
#
